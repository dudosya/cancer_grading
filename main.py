...
def exp1():
    ...
    myModel = AlexNetCustom_CBAM3(num_classes=CONFIGURE.num_classes, lr = CONFIGURE.learning_rate).to(device=device)
...
def exp2():
    ...
    myModel = ResNet34Custom_CBAM3(num_classes=CONFIGURE.num_classes, lr = CONFIGURE.learning_rate).to(device=device)
...
def exp3():
    ...
    myModel = VGG16Custom_CBAM3(num_classes=CONFIGURE.num_classes, lr = CONFIGURE.learning_rate).to(device=device)
